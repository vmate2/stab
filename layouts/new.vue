<template>
  <main>
    ...
    <div class="content">
      <client-only>
        <Profile v-if="currentUser" :profile = "currentUser"/>
      </client-only>
      <slot />
    </div>
  </main>
...
const fetchCurrentUser = async () => {
  if (!token.value) return; // Ensure token exists before making the call
