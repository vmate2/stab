  ...
  <div style="display: flex; justify-content: center; align-items: center; flex-direction: column;">
    ...
    <div class="tableContainer">
      ...
      <div class="listRow headerRow">
        ...
        <div class="listItem header" @click="toggleSort('position')">
          Poszt
      ...
      <div class="listCont2Div" ref="listCont2">
        <div class="listCont2">
          ...
          <div v-for="(person, index) in sortedAndFilteredPeople" :key="person.id" class="listRow" :class="{ even: index % 2 === 0, last: index === sortedAndFilteredPeople.length - 1 }">
            <div class="listItem">{{ person.name }}</div>
            <div class="listItem">{{ person.position }}</div>
            <div class="listItem">{{ person.email }}</div>
            <div class="listItem">{{ person.phone }}</div>
            <div class="listItem">{{ person.paid }}Ft</div>
...
// Sorting state
const sortColumn = ref<'name' | 'position' | 'email' | 'phone' | 'paid' | 'school' | 'city' | null>(null);
const sortDirection = ref<'asc' | 'desc' | null>(null);

// Example list of people
const people = ref([
  { id: 1, name: 'John Doe', position: 'Stábtag', email: 'john@example.com', phone: '123-456-7890', paid: 1000, school: 'Trefort', city: 'Békécsaba' },
  { id: 2, name: 'Jane Smith', position: 'Kisfőnök', email: 'jane@example.com', phone: '987-654-3210', paid: 500, school: 'Keri', city: 'Gyula' },
  { id: 3, name: 'Alice Johnson', position: 'Kampányfőnök', email: 'alice@example.com', phone: '555-555-5555', paid: 2000, school: 'Szegya', city: 'Orosháza' },
  { id: 4, name: 'Bob Brown', position: 'Jelölt', email: 'bob@example.com', phone: '111-222-3333', paid: 0, school: 'Vízmű', city: 'Szarvas' },
  { id: 5, name: 'John Doe', position: 'Stábtag', email: 'john@example.com', phone: '123-456-7890', paid: 1000, school: 'Trefort', city: 'Békécsaba' },
  { id: 6, name: 'Jane Smith', position: 'Kisfőnök', email: 'jane@example.com', phone: '987-654-3210', paid: 500, school: 'Keri', city: 'Gyula' },
  { id: 7, name: 'Alice Johnson', position: 'Kampányfőnök', email: 'alice@example.com', phone: '555-555-5555', paid: 2000, school: 'Szegya', city: 'Orosháza' },
  { id: 8, name: 'Bob Brown', position: 'Jelölt', email: 'bob@example.com', phone: '111-222-3333', paid: 0, school: 'Vízmű', city: 'Szarvas' },
  { id: 9, name: 'John Doe', position: 'Stábtag', email: 'john@example.com', phone: '123-456-7890', paid: 1000, school: 'Trefort', city: 'Békécsaba' },
  { id: 10, name: 'Jane Smith', position: 'Kisfőnök', email: 'jane@example.com', phone: '987-654-3210', paid: 500, school: 'Keri', city: 'Gyula' },
  { id: 11, name: 'Alice Johnson', position: 'Kampányfőnök', email: 'alice@example.com', phone: '555-555-5555', paid: 2000, school: 'Szegya', city: 'Orosháza' },
  { id: 12, name: 'Bob Brown', position: 'Jelölt', email: 'bob@example.com', phone: '111-222-3333', paid: 0, school: 'Vízmű', city: 'Szarvas' },
  { id: 13, name: 'John Doe', position: 'Stábtag', email: 'john@example.com', phone: '123-456-7890', paid: 1000, school: 'Trefort', city: 'Békécsaba' },
  { id: 14, name: 'Jane Smith', position: 'Kisfőnök', email: 'jane@example.com', phone: '987-654-3210', paid: 500, school: 'Keri', city: 'Gyula' },
  { id: 15, name: 'Alice Johnson', position: 'Kampányfőnök', email: 'alice@example.com', phone: '555-555-5555', paid: 2000, school: 'Szegya', city: 'Orosháza' },
  { id: 16, name: 'Bob Brown', position: 'Jelölt', email: 'bob@example.com', phone: '111-222-3333', paid: 0, school: 'Vízmű', city: 'Szarvas' },
  { id: 17, name: 'John Doe', position: 'Stábtag', email: 'john@example.com', phone: '123-456-7890', paid: 1000, school: 'Trefort', city: 'Békécsaba' },
  { id: 18, name: 'Jane Smith', position: 'Kisfőnök', email: 'jane@example.com', phone: '987-654-3210', paid: 500, school: 'Keri', city: 'Gyula' },
  { id: 19, name: 'Alice Johnson', position: 'Kampányfőnök', email: 'alice@example.com', phone: '555-555-5555', paid: 2000, school: 'Szegya', city: 'Orosháza' },
  { id: 20, name: 'Bob Brown', position: 'Jelölt', email: 'bob@example.com', phone: '111-222-3333', paid: 0, school: 'Vízmű', city: 'Szarvas' },
]);
...
const filteredPeople = computed(() => {
  return people.value.filter(person => {
    ...
    const matchesRole = !selectedRole.value.toLowerCase() || person.position.toLowerCase() === selectedRole.value.toLowerCase();
